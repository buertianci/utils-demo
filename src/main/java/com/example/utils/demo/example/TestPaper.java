...
// 本试卷唯一 ID: F4859ADE9D6325633185638D908898CD, 请勿修改本行内容
/* 注意, 这里不要写包名. 留空 */
...
public class TestPaper {
    ...
    */
    ...
    /* qn7:
        "没人比我更懂java".toCharArray(), 在java(jdk8)中关于这个字符数组char[], 以下说法正确的是:A

        A. 这个字符串在内存中总共占用 16 byte

        B. 这个字符串在内存中总共占用 20 byte
